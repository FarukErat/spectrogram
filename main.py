...
def save_spectrogram(audio_file_path, image_file_path, min_hz=None, max_hz=None,
    ...
    plt.savefig(image_file_path, bbox_inches='tight', dpi=dpi, format=format)
    plt.close(fig)

# Example usage:
save_spectrogram("record.wav", "spectrogram.png", max_hz=2500, min_db=-15, dpi=300)
